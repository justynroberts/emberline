...
/// somebody's carefully tuned output, so OpenBurn never does that.
/// </summary>
public static class GcodeImporter
{
    ...
    public static GcodeImportResult Parse(string text, double maxSpindle = 1000)
    {
        ...
        {
            warnings.Add("This file is in inch mode (G20). OpenBurn converted it for the preview; the controller will need to be in G20 as well.");
        }
