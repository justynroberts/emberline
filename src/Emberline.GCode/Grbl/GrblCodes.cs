...
public static class GrblCodes
{
    public static readonly IReadOnlyDictionary<int, GrblCodeInfo> Errors = new Dictionary<int, GrblCodeInfo>
    {
        ...
        [11] = new(11, "Line overflow", "The line exceeded the controller's 80-character receive buffer.", "Shorten the line. Emberline normally prevents this — please report it."),
