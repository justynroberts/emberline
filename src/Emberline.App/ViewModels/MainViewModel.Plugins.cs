...
public sealed partial class MainViewModel
{
    ...
    /// <summary>Try the plugin importers for a file Emberline does not recognise.</summary>
    ...
    private void TogglePlugins()
    {
        ...
        Console.AppendInfo(Settings.PluginsEnabled
            ? "Plugin loading is on. Restart Emberline to load them. A plugin runs with your permissions and is not sandboxed — only load ones you trust."
            : "Plugin loading is off. Restart Emberline to unload them.");
