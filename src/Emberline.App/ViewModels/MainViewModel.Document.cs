...
public sealed partial class MainViewModel
{
    ...
    private async Task OpenAsync()
    {
        ...
        var files = await storage.OpenFilePickerAsync(new FilePickerOpenOptions
        {
            ...
            [
                ...
                {
                    Patterns = ["*.emberline", "*.openburn", "*.svg", "*.dxf", "*.png", "*.jpg", "*.jpeg", "*.bmp", "*.gif", "*.webp",
                                "*.nc", "*.gcode", "*.gc", "*.tap", "*.ngc"],
                },
                new FilePickerFileType("Emberline design") { Patterns = ["*.emberline", "*.openburn"] },
    ...
    private async Task SaveDesignAsAsync()
    {
        ...
        var file = await storage.SaveFilePickerAsync(new FilePickerSaveOptions
        {
            ...
            FileTypeChoices =
            [
                new FilePickerFileType("Emberline design") { Patterns = ["*" + DesignFile.Extension] },
            ],
        }).ConfigureAwait(true);
    ...
    public void ImportFile(string path)
    {
        ...
        try
        {
            ...
            {
                Console.AppendError($"Emberline does not know how to open {Path.GetExtension(path)} files.");
                return;
            }
