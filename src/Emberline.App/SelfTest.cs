...
using TraceOptions = Emberline.Cam.Trace.TraceOptions;
...
/// <summary>
/// A headless end-to-end check, run with <c>Emberline --selftest</c>.
///
...
public static class SelfTest
{
    public static async Task<int> RunAsync()
    {
        ...
        Console.WriteLine("Emberline self-test");
        Console.WriteLine("==================");
        Console.WriteLine();
        ...
        // --- Bundled fonts ------------------------------------------------------
        var fonts = Emberline.Cam.Text.TextOutliner.RegisterBundledFonts();
        ...
        // --- SVG import --------------------------------------------------------
        var svgPath = FindSample("emberline-badge.svg");
        ...
        // --- Text ---------------------------------------------------------------
        var text = Emberline.Cam.Text.TextOutliner.Create("Ob", new Emberline.Cam.Text.TextLayoutOptions
        {
            FontSizeMm = 20,
        ...
        // --- Plugins ------------------------------------------------------------
        var pluginRegistry = new Emberline.Plugins.PluginRegistry();
        var pluginReport = Emberline.Plugins.PluginHost.Load(pluginRegistry, enabled: true);
