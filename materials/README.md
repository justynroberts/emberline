...
Built-in materials ship inside `Emberline.Materials`. This folder is for exported
and shared profiles — a JSON array of `MaterialProfile` objects, the same shape the
in-app **Export materials** command produces.

Settings are always tied to the wattage they were measured at. Emberline will
